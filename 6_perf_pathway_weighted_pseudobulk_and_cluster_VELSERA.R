...
de_results_dataframe <- read.table(paste0("~/Results/", analysis_directory, "DGE_results/Weighted_DGE_results_total_pseudobulk.tsv"), header = TRUE)
de_results_dataframe_cluster <- read.table(paste0("~/Results/", analysis_directory, "DGE_results/Weighted_DGE_results_per_cluster.tsv"), header = TRUE)
...
params_for_post_process <- list(
  ...
  results_file_name = paste0(pathway_results_directory, "Weighted_All_path_results_total_pseudobulk.tsv")
)
...
params_for_post_process <- list(
  ...
  results_file_name = paste0(pathway_results_directory, "Weighted_All_path_results_per_cluster.tsv")
)
...
params_for_post_process <- list(
  colnames_for_empty_df = c("pathway", "pval", "padj", "NES", "size", "leadingEdge", "pathway_level", "group1", "group2", "group", "database"),
  ncols_for_empty_df = 11,
  results_file_name = paste0(pathway_results_directory, "Weighted_Main_path_results_total_pseudobulk.tsv")
)
...
params_for_post_process <- list(
  colnames_for_empty_df = c("pathway", "pval", "padj", "NES", "size", "leadingEdge", "pathway_level", "group1", "group2", "group", "database", "cluster", "cluster_res"),
  ncols_for_empty_df = 13,
  results_file_name = paste0(pathway_results_directory, "Weighted_Main_path_results_per_cluster.tsv")
)
...
params_for_post_process <- list(
  colnames_for_empty_df = c("pathway", "pval", "padj", "NES", "size", "leadingEdge", "pathway_level", "group1", "group2", "group", "database"),
  ncols_for_empty_df = 11,
  results_file_name = paste0(pathway_results_directory, "Weighted_Parent_path_results_total_pseudobulk.tsv")
)
...
params_for_post_process <- list(
  colnames_for_empty_df = c("pathway", "pval", "padj", "NES", "size", "leadingEdge", "pathway_level", "group1", "group2", "group", "database", "cluster", "cluster_res"),
  ncols_for_empty_df = 13,
  results_file_name = paste0(pathway_results_directory, "Weighted_Parent_path_results_per_cluster.tsv")
)
